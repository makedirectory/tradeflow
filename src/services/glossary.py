...
_DEFS: Dict[str, str] = {
    ...
    "cagr": "Compound annual growth rate, %%. The cross-window comparison number (annualized).",
    ...
    "ulcer_index": "RMS drawdown depth (%%) - penalizes deep AND long drawdowns. Lower is better.",
    ...
    "downside_deviation": "Annualized std of negative returns only (%%).",
