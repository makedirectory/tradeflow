...
estimators live in :mod:`tradeflow.risk.sample`. Everything is research-clock: Σ is a tool
...
def build_risk_matrix(
    ...
    (``Σ_t = D_t·R·D_t`` - see :mod:`tradeflow.risk.conditional`), *before* the
    ...
    if conditional:
        from tradeflow.risk.conditional import condition_risk_matrix
