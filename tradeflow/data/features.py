...
def add_risk_features(
    ...
    **The alpha/risk vol seam.** This ``residual_vol`` is
    ...
    (:mod:`tradeflow.risk.conditional`) conditions on recent volatility. Do not "unify"
...
def add_factor_exposure_features(
    ...
    (:func:`tradeflow.risk.exposures.build_factor_exposures`), so "factor-neutral" in the
