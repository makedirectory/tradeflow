...
def cost_curvature(k_imp: float, typical_trade: float) -> Optional[float]:
    ...
    (:func:`tradeflow.portfolio.policy.derive_kappa`); our cost is linear+3/2-power, so
    ...
    size is non-positive - the signal for :func:`~tradeflow.portfolio.policy.derive_kappa`
