...
:class:`~tradeflow.research.llm.LLMClient` (Claude, GPT, or a local Ollama model), so
...
from tradeflow.research.llm import LLMClient, build_llm_client
...
class LLMProposer(Proposer):
    """Proposer backed by any :class:`~tradeflow.research.llm.LLMClient`.
    ...
    Code proposals are *untrusted text* until :mod:`tradeflow.research.sandbox` has
...
_CODEGEN_SYSTEM_PROMPT = (
    ...
    "- Define exactly one concrete subclass of `Strategy` (from tradeflow.strategies.base).\n"
    "- Imports are limited to: pandas, numpy, math, tradeflow.indicators.indicators, tradeflow.strategies.base. "
