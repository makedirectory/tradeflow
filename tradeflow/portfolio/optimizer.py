...
The OR-Tools :class:`~tradeflow.portfolio.allocator.PortfolioAllocator` maximizes a scalar
...
class CostInputs:
    ...
    #: default (:meth:`~tradeflow.costs.base.CostModel.borrow_rate`). Only priced for
